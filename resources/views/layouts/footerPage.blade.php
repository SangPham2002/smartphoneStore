                            ...
                            <div class="col-md-6 col-lg-3 mb-md-30px mb-lm-30px">
                                <div class="single-wedge">
                                    <div class="footer-logo">
                                        <a href="{{ Route('homePage.index') }}"><img
                                                src="/assets/images/logo/footer-logo.png" style="width: 150px"
                                                alt=""></a>
                                    </div>
                        ...
                        <div class="line-shape-top line-height-1">
                            <div class="row flex-md-row-reverse align-items-center">
                                ...
                                <div class="col-md-6 text-center text-md-start">
                                    <p class="copy-text"> © 2022 <strong>SSMobile</strong> Made With <i
                                            class="fa fa-heart" aria-hidden="true"></i> By <a class="company-name"
                                            href="">
                                            <strong> SangPham </strong></a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-6 col-sm-12 col-xs-12" data-aos="fade-up" data-aos-delay="200">
                                <div class="product-details-content quickview-content">
                                    ...
                                    <p class="mt-30px">Lorem ipsum dolor sit amet, consecte adipisicing elit, sed do
                                        eiusmll tempor incididunt ut labore et dolore magna aliqua. Ut enim ad mill
                                        veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip exet commodo
    ...
    <script src="/assets/js/main.min.js"></script> -->
        ...
        <!-- Mirrored from htmldemo.net/hmart/hmart/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 03:32:40 GMT -->
