...
<!-- Mirrored from htmldemo.net/hmart/hmart/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Nov 2022 03:32:04 GMT -->
                    ...
                    <div class="row justify-content-between align-items-center">
                        <div class="col">
                            <div class="welcome-text">
                                <p>HOÀN TRẢ VÀ FREESHIP TRÊN TOÀN QUỐC</p>
                            </div>
                        </div>
                        <div class="col d-none d-lg-block">
                            <div class="top-nav">
                                <ul>
                                    ...
                                    <li><a href="ssmobile@gmail.com"><i class="fa fa-envelope-o"></i>
                                            ssmobile@gmail.com</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-between align-items-center">
                        <div class="col-lg-3 col">
                            <div class="header-logo">
                                <a href="{{ Route('homePage.index') }}"><img src="/assets/images/logo/logo.png"
                                        style="width: 120px" alt="Site Logo" /></a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col">
                            <div class="header-actions">
                                @if (Auth::check())
                                    <a href="{{ Route('homePage.account') }}"><i class="fa fa-user"
                                            style="color: #fff; font-size: 24px"></i>{{ Auth::user()->name }}</a>
                                @else
                                    <a href="{{ Route('homePage.loginPage') }}"><i class="fa fa-user"
                                            style="color: #fff; font-size: 24px"></i></a>
                                @endif
                                <!-- Single Wedge Start -->
                                <a href="#offcanvas-wishlist" class="header-action-btn offcanvas-toggle pr-0">
                ...
                <div class="container">
                    <div class="header-nav">
                        <div class="main-menu position-relative">
                            <ul>
                                <li class="dropdown"><a href="{{ Route('homePage.index') }}">Trang Chủ</a>
                                </li>
                                ...
                                <li class="dropdown position-static"><a href="{{route('homePage.shop')}}">Sản Phẩm </a>
                                    {{-- <i
